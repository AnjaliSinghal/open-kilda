...
public abstract class IngressFlowModFactory {
     ...
     */
    public Optional<OFFlowMod> makeServer42InputFlowMessage() {
        RulesContext context = command.getRulesContext();

        return Server42InputFlowGenerator.generateFlowMod(of, switchFeatures,
                context.getServer42Port(), command.getEndpoint().getPortNumber(), context.getServer42MacAddress());
    }
