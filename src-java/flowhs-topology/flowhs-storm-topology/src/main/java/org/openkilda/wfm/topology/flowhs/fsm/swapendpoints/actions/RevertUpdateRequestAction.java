...
public class RevertUpdateRequestAction
    ...
    public void execute(State from, State to, Event event, FlowSwapEndpointsContext context,
        ...
        sendUpdateCommand(RequestedFlowMapper.INSTANCE.toFlowRequest(firstOriginalFlow),
                secondOriginalFlow.getFlowId(), stateMachine);
        sendUpdateCommand(RequestedFlowMapper.INSTANCE.toFlowRequest(secondOriginalFlow),
                firstOriginalFlow.getFlowId(), stateMachine);
    }
